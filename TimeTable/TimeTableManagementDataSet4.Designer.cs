...
namespace TimeTable {
    ...
    public partial class TimeTableManagementDataSet4 : global::System.Data.DataSet {
        ...
        public partial class SessionDataTable : global::System.Data.TypedTableBase<SessionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SessionRow AddSessionRow(string Lecturer_Name_1, string Lecturer_Name_2, string Subject_Code, string Subject_Name, string Group_ID, string Tag, string Room) {
            ...
            private void InitClass() {
                ...
                this.columnLecturer_Name_1.AllowDBNull = false;
                this.columnLecturer_Name_1.MaxLength = 2147483647;
                this.columnLecturer_Name_2.AllowDBNull = false;
...
namespace TimeTable.TimeTableManagementDataSet4TableAdapters {
    ...
    public partial class SessionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Session] ([Lecturer_Name_1], [Lecturer_Name_2], [Subject_Code], [Subject_Name], [Group_ID], [Tag], [Room]) VALUES (@Lecturer_Name_1, @Lecturer_Name_2, @Subject_Code, @Subject_Name, @Group_ID, @Tag, @Room);
SELECT Session_ID, Lecturer_Name_1, Lecturer_Name_2, Subject_Code, Subject_Name, Group_ID, Tag, Room FROM Session WHERE (Session_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Session] SET [Lecturer_Name_1] = @Lecturer_Name_1, [Lecturer_Name_2] = @Lecturer_Name_2, [Subject_Code] = @Subject_Code, [Subject_Name] = @Subject_Name, [Group_ID] = @Group_ID, [Tag] = @Tag, [Room] = @Room WHERE (([Session_ID] = @Original_Session_ID));
SELECT Session_ID, Lecturer_Name_1, Lecturer_Name_2, Subject_Code, Subject_Name, Group_ID, Tag, Room FROM Session WHERE (Session_ID = @Session_ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Lecturer_Name_1", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Lecturer_Name_1", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Lecturer_Name_2", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Lecturer_Name_2", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Session_ID, Lecturer_Name_1, Lecturer_Name_2, Subject_Code, Subject_Name, " +
                "Group_ID, Tag, Room FROM dbo.Session";
        ...
        public virtual int Fill(TimeTableManagementDataSet4.SessionDataTable dataTable) {
        ...
        public virtual TimeTableManagementDataSet4.SessionDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TimeTableManagementDataSet4.SessionDataTable dataTable = new TimeTableManagementDataSet4.SessionDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TimeTableManagementDataSet4.SessionDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TimeTableManagementDataSet4 dataSet) {
        ...
        public virtual int Insert(string Lecturer_Name_1, string Lecturer_Name_2, string Subject_Code, string Subject_Name, string Group_ID, string Tag, string Room) {
            if ((Lecturer_Name_1 == null)) {
                throw new global::System.ArgumentNullException("Lecturer_Name_1");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(Lecturer_Name_1));
            }
            if ((Lecturer_Name_2 == null)) {
                throw new global::System.ArgumentNullException("Lecturer_Name_2");
            }
            else {
        ...
        public virtual int Update(string Lecturer_Name_1, string Lecturer_Name_2, string Subject_Code, string Subject_Name, string Group_ID, string Tag, string Room, int Original_Session_ID, int Session_ID) {
            if ((Lecturer_Name_1 == null)) {
                throw new global::System.ArgumentNullException("Lecturer_Name_1");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(Lecturer_Name_1));
            }
            if ((Lecturer_Name_2 == null)) {
                throw new global::System.ArgumentNullException("Lecturer_Name_2");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Lecturer_Name_2));
            }
            if ((Subject_Code == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Session_ID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Lecturer_Name_1, string Lecturer_Name_2, string Subject_Code, string Subject_Name, string Group_ID, string Tag, string Room, int Original_Session_ID) {
            return this.Update(Lecturer_Name_1, Lecturer_Name_2, Subject_Code, Subject_Name, Group_ID, Tag, Room, Original_Session_ID, Original_Session_ID);
        }
    }
